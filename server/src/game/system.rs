...
pub(crate) fn new_players(
    ...
    while let Ok(new_player) = new_player_rx.0.try_recv() {
        ...
        commands.spawn((
            component::Spawn,
            component::Kind(protocol::Kind::Spawn),
...
pub(crate) fn terrain(
    zone_extenders: Query<
        ...
        Without<HasExtended>,
    >,
    spawns: Query<&component::RapierObject, With<component::Spawn>>,
            ...
            'here: for y in -radius..radius {
                    ...
                    < radius.pow(2) as f32
                {
                    ...
                    commands.spawn((
                        component::Resource,
                        component::RapierObject { rapier_hdl },
                        component::Kind(protocol::Kind::Mineral),
                        component::Id(helper::gen_id()),
                    ));
                }
            }
                            ...
                            player.owned_factories.insert(
                                ...
                                commands
                                    .spawn((
                                        ...
                                        component::Kind(protocol::Kind::Factory),
                                        component::Id(id),
                                    ))
                                    .id(),
                            );
